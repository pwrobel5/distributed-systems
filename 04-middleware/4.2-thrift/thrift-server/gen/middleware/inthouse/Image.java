...
public class Image implements org.apache.thrift.TBase<Image, Image._Fields>, java.io.Serializable, Cloneable, Comparable<Image> {
  ...
  private static final org.apache.thrift.protocol.TField DATE_TAKEN_FIELD_DESC = new org.apache.thrift.protocol.TField("dateTaken", org.apache.thrift.protocol.TType.STRING, (short)2);
  ...
  public @org.apache.thrift.annotation.Nullable java.lang.String dateTaken; // required

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    DATA((short)1, "data"),
    DATE_TAKEN((short)2, "dateTaken");
  ...
  static {
    ...
    tmpMap.put(_Fields.DATE_TAKEN, new org.apache.thrift.meta_data.FieldMetaData("dateTaken", org.apache.thrift.TFieldRequirementType.DEFAULT, 
  ...
  public Image setData(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer data) {
    this.data = org.apache.thrift.TBaseHelper.copyBinary(data);
    return this;
  }
  ...
  public Image setDateTaken(@org.apache.thrift.annotation.Nullable java.lang.String dateTaken) {
    this.dateTaken = dateTaken;
    return this;
  }
  ...
  /** Returns true if field dateTaken is set (has been assigned a value) and false otherwise */
  public boolean isSetDateTaken() {
    return this.dateTaken != null;
  }

  public void setDateTakenIsSet(boolean value) {
    if (!value) {
      this.dateTaken = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case DATE_TAKEN:
      if (value == null) {
        ...
        setDateTaken((java.lang.String)value);
      }
      break;
  ...
  public boolean equals(Image that) {
    ...
    boolean this_present_dateTaken = true && this.isSetDateTaken();
    boolean that_present_dateTaken = true && that.isSetDateTaken();
    if (this_present_dateTaken || that_present_dateTaken) {
      if (!(this_present_dateTaken && that_present_dateTaken))
        return false;
      if (!this.dateTaken.equals(that.dateTaken))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetDateTaken()) ? 131071 : 524287);
    if (isSetDateTaken())
      hashCode = hashCode * 8191 + dateTaken.hashCode();
  ...
  public int compareTo(Image other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetDateTaken()).compareTo(other.isSetDateTaken());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDateTaken()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.dateTaken, other.dateTaken);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class ImageStandardScheme extends org.apache.thrift.scheme.StandardScheme<Image> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, Image struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 2: // DATE_TAKEN
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.dateTaken = iprot.readString();
              struct.setDateTakenIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Image struct) throws org.apache.thrift.TException {
      ...
      if (struct.dateTaken != null) {
        oprot.writeFieldBegin(DATE_TAKEN_FIELD_DESC);
        oprot.writeString(struct.dateTaken);
        oprot.writeFieldEnd();
      }
